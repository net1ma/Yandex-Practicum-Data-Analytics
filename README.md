...
В представленном репозитории хранится список проектов, выполненных в рамках курса «‎Аналитик данных» на платформе Яндекс.Практикум. Проект написаны на языках Python и SQL. Решение подготовлены в Jupyter Notebook.
